...
function createPublisher(packager, options, publisherName) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (publisherName === "bintray") {
            ...
            const bintrayInfo = { user: info.user, package: info.project, repo: "generic" };
            log_1.log(`Creating Bintray Publisher — user: ${ bintrayInfo.user }, package: ${ bintrayInfo.package }, repository: ${ bintrayInfo.repo }, version: ${ version }`);
